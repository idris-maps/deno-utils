import { ready, parse } from './markdown.embed.js'
...
export interface ParseOptions {
  ...
  bytes? :boolean
  allowJSURIs? :boolean
  onCodeBlock? :(langname :string, body :Uint8Array) => Uint8Array|string|null|undefined
}
...
export const toString = async (s: Source, o?: ParseOptions): Promise<string> => {
  await ready
  return parse(s, { ...(o || {}), bytes: false })
}

export const toUint8Array = async (s: Source, o?: ParseOptions): Promise<Uint8Array> => {
  await ready
