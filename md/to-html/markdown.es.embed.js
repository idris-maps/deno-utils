...
var e,
  ...
  x,
  N,
  C = "object" == typeof process && "object" == typeof process.versions &&
    "string" == typeof process.versions.node && "function" == typeof require;
let D;
if (C) {
  try {
    D = require("path");
...
"undefined" != typeof module && (e = module, module = void 0),
  (n = {
    ...
    instantiateWasm(e, n) {
      let t = new WebAssembly.Instance(new WebAssembly.Module(J(U)), e);
      return n(t), t.exports;
    },
    wasmBinary: WASM_DATA,
  }).ready = new Promise((e) => {
    n.onRuntimeInitialized = () => {
      e({});
    };
  }),
  C && D && (n.locateFile = function (e) {
    return D.join(__dirname, e);
  }),
  n.print;
let j = n.printErr;
for (r in t = {}, n = void 0 !== n ? n : {}) {
...
for (
  r in o = [],
    ...
    a = "",
    "object" == typeof process && "object" == typeof process.versions &&
      "string" == typeof process.versions.node
      ? (a = u ? require("path").dirname(a) + "/" : __dirname + "/",
        s = function (e, n) {
          return l || (l = require("fs")),
            p || (p = require("path")),
            e = p.normalize(e),
    ...
    try {
      ...
      i = function (e, n) {
        ...
        return "v" == u ? i.push(0) : i = i.concat([1, s[u]]),
          ...
          f = new WebAssembly.Module(c),
          new WebAssembly.Instance(f, { e: { f: e } }).exports.f;
      }(e, n), _.set(o, i);
    }
    return m.set(e, o), o;
  }(e, n);
...
function J(e) {
  try {
    if (e == U && y) return new Uint8Array(y);
    if (f) return f(e);
...
function Y(e) {
  try {
    return h.grow(e - A.byteLength + 65535 >>> 16), X(h.buffer), 1;
  } catch (e) {}
}
function Q(e) {
  function t() {
...
if (
  t = null,
    ...
    z(U = "markdown-es.wasm") ||
    (N = U, U = n.locateFile ? n.locateFile(N, a) : a + N),
    M = {
      a: function (e) {
        var n, t, r, o, i = g.length;
    ...
    function () {
      ...
      function t(e, t) {
        ...
        n.asm = o,
          ...
          function (e) {
            if (
              T--,
                n.monitorRunDependencies && n.monitorRunDependencies(T),
                0 == T && (null !== v && (clearInterval(v), v = null), W)
            ) {
              var t = W;
              W = null, t();
            }
      ...
      function o(n) {
        return function () {
          if (!y && (i || u)) {
            if ("function" == typeof fetch && !V(U)) {
              return fetch(U, { credentials: "same-origin" }).then(
                function (e) {
                  if (!e.ok) {
          ...
          j("failed to asynchronously prepare wasm: " + e), q(e);
        });
      }
      if (
        T++,
        ...
        try {
          ...
          return j("Module.instantiateWasm callback failed with error: " + e),
            !1;
        }
      }
      y || "function" != typeof WebAssembly.instantiateStreaming || z(U) ||
        V(U) || "function" != typeof fetch
        ? o(r)
        : fetch(U, { credentials: "same-origin" }).then(function (n) {
          return WebAssembly.instantiateStreaming(n, e).then(r, function (e) {
            return j("wasm streaming compile failed: " + e),
    ...
    B = n._WErrClear = function () {
      return (B = n._WErrClear = n.asm.h).apply(null, arguments);
    },
    k = n._parseUTF8 = function () {
  ...
  let o = n.onCodeBlock
    ? (i = n.onCodeBlock,
      K(function (e, n, t, r, o) {
        try {
          const u = n > 0 ? ne.decode(g.subarray(e, e + n)) : "",
            a = g.subarray(t, t + r);
          let s = void 0;
          a.toString = () => s || (s = ne.decode(a));
          let c = null;
          if (null === (c = i(u, a)) || void 0 === c) return -1;
          let f = ue(c);
          if (f.length > 0) {
            const e = Z(f, f.length);
            E[o >> 2] = e;
          }
          return f.length;
        } catch (e) {
  ...
  return n.onCodeBlock && G(o),
    function () {
      let e = function () {
        let e = F();
        if (0 != e) {
          let n = O(), t = 0 != n ? UTF8ArrayToString(g, n) : "";
          return B(), new WError(e, t);
        }
      }();
      if (e) throw e;
    }(),
...
export { ie as parse, re as ParseFlags, te as ready };
//# sourceMappingURL=markdown.es.embed.js.map
